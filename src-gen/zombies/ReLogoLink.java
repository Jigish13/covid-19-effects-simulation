...
public class ReLogoLink<T> extends BaseLink<T>	{
	...
	/**
	 * Returns the value of the global variable hospitalCapacity.
	 *
	 * @return the value of the global variable hospitalCapacity
	 */
	@ReLogoBuilderGeneratedFor("global: hospitalCapacity")
	public Object getHospitalCapacity(){
		return repast.simphony.relogo.ReLogoModel.getInstance().getModelParam("hospitalCapacity");
	}

	/**
	 * Sets the value of the global variable hospitalCapacity.
	 *
	 * @param value
	 *            a value
	 */
	@ReLogoBuilderGeneratedFor("global: hospitalCapacity")
	public void setHospitalCapacity(Object value){
		repast.simphony.relogo.ReLogoModel.getInstance().setModelParam("hospitalCapacity",value);
	}
