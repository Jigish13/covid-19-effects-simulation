...
public class UserGlobalsAndPanelFactory extends AbstractReLogoGlobalsAndPanelFactory{
	public void addGlobalsAndPanelComponents(){
		...
		addSliderWL("numZombies","Number of Infected Patients",1,1,10,5)
		addSliderWL("hospitalCapacity","Capacity of Hospital",10,1,50,25)
		addSliderWL("gestationPeriod","Days it take to infect the patient",5,1,30,5)
